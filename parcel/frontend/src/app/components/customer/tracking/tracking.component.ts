    ...
    <div class="tracking-container">
      <div class="tracking-content">
        ...
        <div class="tracking-header">
          ...
          <p class="tracking-subtitle">Enter your booking ID to get real-time tracking information for your shipment</p>
        </div>
        ...
        <div class="tracking-form-section">
          <div class="form-card">
            <div class="form-header">
              <h2>Track Package</h2>
              <p>Enter your booking ID to track your shipment status</p>
            </div>
              ...
              <div class="details-grid">
                ...
                <div class="detail-item">
                  ...
                  <div class="detail-content">
                    ...
                    <span class="detail-value">{{ trackingResult.createdAt | date:'medium' }}</span>
                  </div>
                </div>
                ...
                <div class="detail-item">
                  ...
                  <div class="detail-content">
                    ...
                    <span class="detail-value">{{ trackingResult.packageType }}</span>
                  </div>
                </div>
                ...
                <div class="detail-item">
                  ...
                  <div class="detail-content">
                    ...
                    <span class="detail-value">{{ trackingResult.weight }} kg</span>
                  </div>
                </div>
              </div>
                ...
                <div class="timeline">
                  <div class="timeline-item completed">
                    ...
                    <div class="timeline-content">
                      ...
                      <span class="timeline-time">{{ trackingResult.createdAt | date:'short' }}</span>
                    </div>
                  </div>

                  <div class="timeline-item" [class.completed]="trackingResult.parcelStatus !== 'PENDING'">
                    <div class="timeline-icon">
                      <mat-icon>{{ trackingResult.parcelStatus !== 'PENDING' ? 'check_circle' : 'radio_button_unchecked' }}</mat-icon>
                    </div>
                    <div class="timeline-content">
                      <h4>Pickup Scheduled</h4>
                      <p>Pickup has been scheduled for your package</p>
                      <span class="timeline-time">In Progress</span>
                    </div>
                  </div>

                  <div class="timeline-item" [class.completed]="trackingResult.parcelStatus === 'IN_TRANSIT' || trackingResult.parcelStatus === 'DELIVERED'">
                    <div class="timeline-icon">
                      <mat-icon>{{ (trackingResult.parcelStatus === 'IN_TRANSIT' || trackingResult.parcelStatus === 'DELIVERED') ? 'check_circle' : 'radio_button_unchecked' }}</mat-icon>
                    </div>
                    <div class="timeline-content">
                      <h4>In Transit</h4>
                      <p>Your package is currently in transit</p>
                      <span class="timeline-time">In Progress</span>
                    </div>
                  </div>

                  <div class="timeline-item" [class.completed]="trackingResult.parcelStatus === 'DELIVERED'">
                    <div class="timeline-icon">
                      <mat-icon>{{ trackingResult.parcelStatus === 'DELIVERED' ? 'check_circle' : 'radio_button_unchecked' }}</mat-icon>
                    </div>
                    <div class="timeline-content">
                      <h4>Delivered</h4>
...
export class TrackingComponent implements OnInit {
  ...
  ngOnInit(): void {
    // No specific initialization needed for tracking form
  }
  ...
  trackPackage() {
    if (this.trackingForm.valid) {
      ...
      this.trackingService.trackCustomerBooking(bookingId).subscribe({
        next: (response) => {
          this.isLoading = false;
          console.log('Tracking response:', response);
          if (response.success) {
            this.trackingResult = response.booking;
            console.log('Tracking result:', this.trackingResult);
          } else {
        ...
        error: (error) => {
          ...
          let errorMessage = 'Tracking failed. Please try again.';
